...
/// <summary>
/// This class is responsible for testing the functionality of the GetInconsistentFlights function.
/// </summary>
...
public class GetInconsistentFlightsTest(FunctionFixture fixture)
{
    ...
    public async Task Get_Flights_Should_Return_200()
    {
        ...
        flight.SetDepartureAirportId(departureAirport.Id)
            ...
            .SetConsistencyType(FlightConsistencyType.Inconsistent)
            .SetInconsistencyReason("Test reason");
